...
# Write data
write_parquet(monthly_ingresos, "src2/data/06_controles_percentage_canon_mensual.parquet")
write_parquet(semestral_ingresos, "src2/data/06_controles_percentage_canon_semestral.parquet")
write_parquet(yearly_ingresos, "src2/data/06_controles_percentage_canon_anual.parquet")
