...
# Write data
write_parquet(monthly_ingresos, "data/02_intermediate/controles_percentage_canon_mensual.parquet")
write_parquet(semestral_ingresos, "data/02_intermediate/controles_percentage_canon_semestral.parquet")
write_parquet(yearly_ingresos, "data/02_intermediate/controles_percentage_canon_anual.parquet")
