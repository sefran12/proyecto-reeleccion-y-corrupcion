...
summary_OSCE <- combined_data_clean %>% 
    select(avg_bidders_per_project, avg_ratio_between_winner_and_publicado, perc_single_bidder, perc_repeated_winners, ) %>% 
    summary()

summary_OSCE %>% write_clip()

# Tendencias temporales

# Overall se encuentra en el otro script. Aqui por tipo de bien
